...
const LandingPage = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <form className="sm:h-14 flex flex-col sm:flex-row w-full md:w-2/4 gap-2" onSubmit={handleShortenUrl} >
        <Input
          type="url"
      ...
      <img src="/banner.jpeg" className="w-full my-11 md:px-11" alt="" />
